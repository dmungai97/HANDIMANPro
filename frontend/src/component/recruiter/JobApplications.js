    ...
    <Paper className={classes.jobTileOuter} elevation={3}>
      <Grid container>
        ...
        <Grid container item xs={7} spacing={1} direction="column">
          ...
          <Grid item>Phone :{application.jobApplicant.contactNumber}</Grid>
          <Grid item>
            <Rating
              value={
          ...
          <Grid item>
            Skills: {application.sop !== "" ? application.sop : "Not Submitted"}
          </Grid>
          <Grid item>
...
const JobApplications = (props) => {
  ...
  return (
    <>
      ...
      >
        <Grid item>
          <Typography variant="h2" style={{color:"black" ,marginBottom:"10px" ,background: "#fff179",opacity:".9"}}>Handyman Applied</Typography>
        </Grid>
        <Grid item>
        ...
        >
          {applications.length > 0 ? (
            ...
            <Typography variant="h5" style={{ textAlign: "center" }}>
              No One Applied For This Service
            </Typography>
          )}
        </Grid>
      </Grid>
